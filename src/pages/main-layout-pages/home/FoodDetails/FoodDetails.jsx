        ...
        <div className="grid md:grid-cols-3 gap-5 text-black dark:text-white mb-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-700 dark:text-white">
              Rennie White, an advertising manager in Dhaka City, leaves for
              work 10 minutes later these days because she no longer has to wait
              in line for coffee at a Dunkin' Donuts outlet. Instead, she
              preorders coffee by sending a text message from her cellphone on
              the way to work. "I can get off the train and get the coffee and
              not break my flow," Ms. White says Similique sunt in culpa qui
              officia deserunt mollitia animi, id est laborum et dolorum fuga.
              uni harum quidem sed rerum facilis est et expedita distinctio. Nam
              libero tempore, cum soluta nobis est eligendi optio cumque
              nihilares impedit quo repellendus eligendi optio cumque nihilare
